...
public class TestFindStartAndEndOfNumber2 {
    ...
    public void testEmpty() {
        int[] arr = new int[]{};
        int[] rs = f.searchRangeInLgNTime(arr, 8);
    ...
    public void test1Element() {
        int[] arr = new int[]{1};
        int[] rs = f.searchRangeInLgNTime(arr, 1);
    ...
    public void test1ElementNotMatch() {
        int[] arr = new int[]{1};
        int[] rs = f.searchRangeInLgNTime(arr, 3);
        Assert.assertArrayEquals(rs, new int[]{-1, -1});
    }
    ...
    public void test2Element() {
        int[] arr = new int[]{1, 2};
        int[] rs = f.searchRangeInLgNTime(arr, 2);
        Assert.assertArrayEquals(rs, new int[]{1, 1});
    }
    ...
    public void test1() {
        ...
        int[] rs = f.searchRangeInLgNTime(arr, 5);
    ...
    public void test3() {
        ...
        int[] rs = f.searchRangeInLgNTime(arr, 10);
    ...
    public void testBorderRight() {
        ...
        int[] rs = f.searchRangeInLgNTime(arr, 4);
    ...
    public void test6() {
        ...
        int[] rs = f.searchRangeInLgNTime(arr, 6);
        Assert.assertArrayEquals(rs, new int[]{-1, -1});
    }
}
